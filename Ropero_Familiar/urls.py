...
urlpatterns = [
    ...
    path('cancelar_donacion/<int:id>/', views.cancel_donation, name='cancel_donation'),
    ...
    path('eliminar_referente/<int:id>/',views.delete_referring, name="delete_referring"),
    path('eliminar_familiar/<int:id>/',views.delete_family, name="delete_family"),
    ...
    path('cancelar_venta/<int:id>/', views.cancel_sale, name='cancel_sale'),
